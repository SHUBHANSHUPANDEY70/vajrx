...
const values = [
  {
    ...
    description:
      "Every system we build starts from the assumption that it can and should be made domestically. We do not default to imported alternatives unless genuinely unavoidable.",
  },
  {
    title: "Precision Over Speed",
    description:
      "We move deliberately. Every design decision is justified, every component is tested, and every system is documented. We would rather build it right than build it fast.",
  },
  {
    title: "Operational Relevance",
    description:
      "We do not build for portfolios or demonstrations. We build for deployment — in hospitals, in defence installations, in research environments. Real-world utility is the only metric that matters.",
  },
  {
    title: "Transparent Process",
    description:
      "From scoping through delivery, clients and collaborators see exactly what we're building, how, and why. No surprises. No scope creep without consent.",
  },
];
...
const roadmapItems = [
  ...
  },
  {
    ...
    desc: "Validate and deploy our airway assessment ML model in hospital pre-operative workflows. Phase 1: clinical validation. Phase 2: hospital system integration. Phase 3: expansion to broader anesthesiology risk parameters.",
    status: "In Progress",
  },
  {
    title: "Defence Technology Scale",
    timeline: "2026+",
    desc: "Expand embedded systems and signal processing capabilities into broader defence and aerospace applications, contributing to India's sovereign technology stack through DRDO and industry partnerships.",
    status: "Roadmap",
  },
  {
    title: "Product Commercialization",
    timeline: "2026+",
    desc: "Transition from project-based work to commercializing core IP — starting with the lightning detection sensor node as a standalone, deployable product for meteorological agencies and airports.",
    status: "Roadmap",
  },
];
      ...
      <div className="pt-14">
        ...
        <section className="relative py-28 px-6 border-b border-border overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            >
              <p className="font-mono text-xs text-accent tracking-[0.3em] uppercase mb-5">About VajrX</p>
              <h1 className="font-display font-bold text-4xl md:text-6xl text-white tracking-tight leading-tight mb-6">
              ...
              <p className="text-muted text-lg leading-relaxed max-w-2xl mb-4">
                VajrX is a technology startup building indigenous solutions across Electronics, Defence, and Medical domains. We take ideas and turn them into precision-engineered realities.
              </p>
              <p className="text-muted/70 text-base leading-relaxed max-w-2xl">
                Founded by engineers from Jabalpur Engineering College with hands-on experience at ISRO, DRDO, and defence institutions — VajrX was built on the conviction that India can and should manufacture the systems it currently imports.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        {/* Mission & Vision */}
        <section className="py-24 px-6 bg-navy/10">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-border divide-y md:divide-y-0 md:divide-x divide-border">
              ...
              >
                ...
                <h2 className="font-display font-bold text-2xl text-white mb-5">What We Are Here to Do</h2>
              ...
              >
                ...
                <h2 className="font-display font-bold text-2xl text-white mb-5">Where We Are Going</h2>
                <p className="text-muted leading-relaxed mb-4">
                ...
                <p className="text-muted/70 text-sm leading-relaxed">
                  We envision a future where Indian-made technology sets the global standard in critical domains. VajrX is building the foundation for that future, one engineered system at a time.
                </p>
              </motion.div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-border divide-x divide-y divide-border">
              {values.map((v, i) => (
                <motion.div
                  ...
                  className="group p-8 hover:bg-surface transition-colors duration-300 relative overflow-hidden"
                >
        ...
        {/* Roadmap */}
        <section className="py-24 px-6 bg-navy/10 border-t border-border">
          <div className="max-w-7xl mx-auto">
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 items-start">
                    <div className="md:col-span-3">
                      <p className="font-mono text-xs text-accent/60 mb-1">{item.timeline}</p>

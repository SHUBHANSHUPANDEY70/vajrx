        ...
        <section className="relative py-28 px-6 border-b border-border overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <h1 className="font-display font-bold text-4xl md:text-6xl text-foreground leading-tight mb-6">What We Build</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              <div className="lg:col-span-4">
                <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                  ...
                  <h2 className="font-display font-bold text-3xl text-foreground leading-tight mb-5">How We Work Together</h2>
        ...
        <section className="py-24 px-6 bg-background">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div>
                <h2 className="font-display font-bold text-3xl text-foreground mb-4">Have a project in mind?</h2>
